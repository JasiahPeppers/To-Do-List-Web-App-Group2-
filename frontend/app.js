document.addEventListener("DOMContentLoaded", () => { 
    ...
    let selectedPriority = 'Low';  // Default priority to 'Low'

    // Priority buttons (to set the task priority)
    const priorityButtons = document.querySelectorAll('.priority-button');
    priorityButtons.forEach(button => {
        button.addEventListener('click', function() {
            selectedPriority = button.textContent;
            priorityButtons.forEach(btn => btn.classList.remove('active'));  // Remove active class from all buttons
    ...
    fetchTasks(); // Call the function to load tasks on page load
    ...
    addButton.addEventListener("click", () => {
        ...
        if (taskValue) {
            ...
            const task = {
                ...
                priority: selectedPriority  // Add selected priority
            };
    ...
    function addTaskToList(task) {
        ...
        listItem.classList.add(task.priority.toLowerCase()); // Add class based on priority for color-coding
