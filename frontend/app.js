...
fetchTasks(); // this should refresh the task list automatically after adding
})
.catch((error) => {
...
fetchTasks(); // Refresh the task list after its deleted
...
fetchTasks(); // this is to update the completed automatically
})
.catch((error) => {
