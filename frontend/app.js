...
// this will actualyl trigger the incomplete button
...
textarea.style.width = '100%'; // Ensures it fills the width of the container
textarea.style.height = '40px'; // Make it similar to the original height
