...
def list_routes(app):
    ...
    #basic routes for add, update, and delete. Might need a few tweeks but should be close generally. May have to add more for more functionality, but for now im keeping it basic.
